...
---
The point of this exercise is to demonstrate understanding of merging, merge commits, and merge conflicts in Git and successfully execute the following relevant commands:
